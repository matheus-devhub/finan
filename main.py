...
# Colors ----------------------------------------------------------------------------------------------------
color_white = "#E6EED6" # white
color_black = "#feffff" # black
co2 = "#4fa882" # mint
...
# Frames ----------------------------------------------------------------------------------------------------
upFrame = Frame(window, width=1043, height=50, bg=color_black, relief="flat")
upFrame.grid(row=0, column=0)

midFrame = Frame(window, width=1043, height=361, bg=color_black, pady=20, relief="raised")
midFrame.grid(row=1, column=0, pady=1, padx=0, sticky=NSEW)

downFrame = Frame(window, width=1043, height=300, bg=color_black, relief="flat")
downFrame.grid(row=2, column=0, pady=0, padx=10, sticky=NSEW)

incomeFrame = Frame(downFrame, width=300, height=250, bg=color_black)
...
app_logo = Label(upFrame, image=app_img, text=" Finan", width=900, compound=LEFT, padx=5, relief=RAISED, anchor=NW, font=('Verdana 20 bold'), bg=color_black, fg=co4)
...
app_table = Label(midFrame, text="Income and expenses table", anchor=NW, font=('Verdana 12'), bg=color_black, fg=co4)
app_table.place(x=5, y=309)

# Expenses configurations ----------------------------------------------------------------------------------------------------
label_info = Label(downFrame, text='Insert new expenses', height=1, anchor=NW, font=('Verdana 10 bold'), bg=color_black, fg=co4)
label_info.place(x=370, y=0)

# Category
label_category = Label(downFrame, text='Category', height=1, anchor=NW, font=('Ivy 10'), bg=color_black, fg=co4)
...
# Calendar
label_calendar_expenses = Label(downFrame, text='Date', height=1, anchor=NW, font=('Ivy 10'), bg=color_black, fg=co4)
...
# Value
label_expenses_value = Label(downFrame, text='Total QTY', height=1, anchor=NW, font=('Ivy 10'), bg=color_black, fg=co4)
...
# Remove Btn
label_remove = Label(downFrame, text='Remove action', height=1, anchor=NW, font=('Ivy 10 bold'), bg=color_black, fg=co4)
...
remove_btn = Button(downFrame, command=delete_data, image=remove_img, text=" Remove".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=color_black, fg=color_white, overrelief=RIDGE)
remove_btn.place(x=470, y=190)

# Revenues configurations ----------------------------------------------------------------------------------------------------
label_info = Label(downFrame, text='Insert new revenues', height=1, anchor=NW, font=('Verdana 10 bold'), bg=color_black, fg=co4)
label_info.place(x=600, y=0)

# Calendar
label_calendar_revenues = Label(downFrame, text='Date', height=1, anchor=NW, font=('Ivy 10'), bg=color_black, fg=co4)
...
# Value
label_revenues_value = Label(downFrame, text='Total QTY', height=1, anchor=NW, font=('Ivy 10'), bg=color_black, fg=co4)
...
add_revenues_btn = Button(downFrame, command=insert_revenues_2, image=add_revenues_img, text=" Add".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=color_black, fg=color_white, overrelief=RIDGE)
add_revenues_btn.place(x=670, y=111)

# New category operations ----------------------------------------------------------------------------------------------------
label_info = Label(downFrame, text='Category', height=1, anchor=NW, font=('Ivy 10 bold'), bg=color_black, fg=co4)
...
add_category_btn = Button(downFrame, command=insert_category_2, image=add_category_img, text=" Add".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=color_black, fg=color_white, overrelief=RIDGE)
add_category_btn.place(x=670, y=190)

# Functions ----------------------------------------------------------------------------------------------------
def percentage():
    label_name = Label(midFrame, text="Percentage of revenue spent", height=1, anchor=NW, font=('Verdana 12'), bg=color_black, fg=co4)
...
def summary():
    ...
    label_summary = Label(midFrame, text="Total monthly income   ".upper(), anchor=NW, font=('Verdana 12'), bg=color_black, fg='#83a9e6')
    label_summary.place(x=309, y=35)
    label_summary = Label(midFrame, text="R$ {:,.2f}".format(value[0]), anchor=NW, font=('Arial 17'), bg=color_black, fg='#545454')
    label_summary.place(x=309, y=70)
    
    label_line = Label(midFrame, text="", width=215, height=1, anchor=NW, font=('Arial 1'), bg='#545454')
    label_line.place(x=309, y=132)
    label_summary = Label(midFrame, text="Total monthly expenses".upper(), anchor=NW, font=('Verdana 12'), bg=color_black, fg='#83a9e6')
    label_summary.place(x=309, y=115)
    label_summary = Label(midFrame, text="R$ {:,.2f}".format(value[1]), anchor=NW, font=('Arial 17'), bg=color_black, fg='#545454')
    label_summary.place(x=309, y=150)
    
    label_line = Label(midFrame, text="", width=215, height=1, anchor=NW, font=('Arial 1'), bg='#545454')
    label_line.place(x=309, y=207)
    label_summary = Label(midFrame, text="Total cash balance      ".upper(), anchor=NW, font=('Verdana 12'), bg=color_black, fg='#83a9e6')
    label_summary.place(x=309, y=190)
    label_summary = Label(midFrame, text="R$ {:,.2f}".format(value[2]), anchor=NW, font=('Arial 17'), bg=color_black, fg='#545454')
